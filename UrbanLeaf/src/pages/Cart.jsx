...
const [address, setAddress] = useState(' Main street, 1651'); 
...
const navigate = useNavigate()
 ...
 <div className = "flex space-x-12 item-center">
...
<button className ="text-xl font-bold px-1.5 border-r" onClick ={() => dispatch(decreaseQuantity(product.id))}>-</button>
 ...
 <button className = 'text-xl px-1 border-1' onClick ={() => dispatch(increaseQuantity(product.id))}>+</button>
    ...
    <button className = "text-green-500 hover:text-white" onClick={()=> dispatch(removeFromCart(product.id))}>
...
<div className = "flex justify-between mb-5 border-b pb-1">
    ...
    <button className = "w-full bg-red-600 text-white py-2 hover:bg-red-800" onClick ={()=> navigate('/checkout')}>Proceed to Checkout
